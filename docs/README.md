...
- **Testing Utilities** - Tools for testing Inertia applications

## Examples

The [`examples/`](../examples/) directory contains working applications:

- **[`examples/minimal/`](../examples/minimal/)** - Complete CRUD application with forms, validation, and file uploads

## Contributing

To contribute to the library or documentation:

1. Review the [implementation plan](development/implementation-plan.md) for current priorities
2. Check the [testing guide](development/testing.md) for testing requirements
