        ...
        examples={[
          {
            ...
            <Deferred :data="['permissions', 'teams']" fallback="Loading...">
              <!-- This will render once both permissions and teams are available -->
            </Deferred>
            `,
          },
          {
            ...
            export default () => (
              <Deferred data={['permissions', 'teams']} fallback={<div>Loading...</div>}>
                {/* This will render once both permissions and teams are available */}
              </Deferred>
            )
            `,
          },
          {
            ...
            language: 'jsx',
            code: dedent`
            <Deferred data={['permissions', 'teams']}>
              <div slot="fallback">Loading...</div>
              <!-- This will render once both permissions and teams are available -->
            </Deferred>
            `,
