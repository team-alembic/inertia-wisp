...
pub fn users_page(req: InertiaContext) -> wisp.Response {
...
pub fn create_user(req: InertiaContext) -> wisp.Response {
  create_handler.create_user(req)
}

pub fn show_user_page(req: InertiaContext, id: String) -> wisp.Response {
  show_handler.show_user_page(req, id)
}

pub fn edit_user_page(req: InertiaContext, id: String) -> wisp.Response {
  edit_handler.edit_user_page(req, id)
}

pub fn update_user(req: InertiaContext, id: String) -> wisp.Response {
  edit_handler.update_user(req, id)
}

pub fn delete_user(req: InertiaContext, id: String) -> wisp.Response {
