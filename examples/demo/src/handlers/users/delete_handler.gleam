...
pub fn delete_user(req: InertiaContext, id_str: String) -> wisp.Response {
...
fn handle_valid_delete_request(req: InertiaContext, id: Int) -> wisp.Response {
...
fn handle_successful_deletion(req: InertiaContext) -> wisp.Response {
