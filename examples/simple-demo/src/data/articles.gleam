...
pub fn init_sample_data(db: Connection) -> Result(Nil, sqlight.Error) {
  let sql =
    ...
    ('New Streaming Series Breaks Records', 'Fantasy epic becomes most-watched premiere in platform history', 'Lisa Park', '2024-01-15T06:00:00Z', 'entertainment', 6, 'https://images.unsplash.com/photo-1574375927938-d5a98e8ffe85'),
    ...
    ('Climate Change Research Shows Progress', 'New carbon capture technology shows promising results', 'Dr. Maria Santos', '2024-01-14T20:45:00Z', 'science', 6, 'https://images.unsplash.com/photo-1611273426858-450d8e3c9fce'),
    ...
    ('Trade Deadline Shakeups Expected', 'Teams prepare for major roster changes ahead of deadline', 'Kevin Brown', '2024-01-14T13:00:00Z', 'sports', 4, 'https://images.unsplash.com/photo-1552667466-07770ae110d0'),
    ...
    ('Machine Learning Breakthrough', 'Researchers develop faster training algorithms for neural networks', 'Dr. Patricia Wong', '2024-01-13T20:15:00Z', 'technology', 6, 'https://images.unsplash.com/photo-1677442136019-21780ecad995'),
    ...
    ('Film Festival Announces Winners', 'Independent cinema takes center stage at annual awards', 'Emma Rodriguez', '2024-01-13T15:15:00Z', 'entertainment', 5, 'https://images.unsplash.com/photo-1574375927938-d5a98e8ffe85'),
    ...
    ('Streaming Content Trends', 'International productions gain global audience appeal', 'Lisa Park', '2024-01-12T14:15:00Z', 'entertainment', 6, 'https://images.unsplash.com/photo-1574375927938-d5a98e8ffe85'),
    ...
    ('Climate Modeling Advances', 'Supercomputers improve weather prediction accuracy', 'Dr. Maria Santos', '2024-01-12T04:15:00Z', 'science', 8, 'https://images.unsplash.com/photo-1611273426858-450d8e3c9fce'),
    ...
    ('Extreme Sports Safety', 'New equipment technology reduces injury rates significantly', 'Kevin Brown', '2024-01-11T14:30:00Z', 'sports', 4, 'https://images.unsplash.com/photo-1552667466-07770ae110d0'),
    ('Social Media Evolution', 'Decentralized platforms challenge traditional network models', 'Emma Rodriguez', '2024-01-11T13:15:00Z', 'entertainment', 5, 'https://images.unsplash.com/photo-1574375927938-d5a98e8ffe85')
    "
