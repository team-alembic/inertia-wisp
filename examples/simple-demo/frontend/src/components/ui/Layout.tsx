...
export const PageHeader: React.FC<LayoutProps> = ({ children, className = "" }) => (
...
export const PageContent: React.FC<LayoutProps> = ({ children, className = "" }) => (
...
export const FlexBetween: React.FC<LayoutProps> = ({ children, className = "" }) => (
  <div className={`flex items-center justify-between ${className}`}>
    {children}
  </div>
);

export const FlexCenter: React.FC<LayoutProps> = ({ children, className = "" }) => (
