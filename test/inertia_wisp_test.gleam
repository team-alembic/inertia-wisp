...
fn print_usage() -> Nil {
  ...
  io.println("")
  io.println("Examples:")
  io.println("  gleam test -- response_builder - run response builder tests")
  io.println("  gleam test -- prop             - run prop-related tests")
}
...
///
/// ## Parameters
/// - `module_name`: The name of the test module to run (e.g., "response_builder_test")
///
/// ## Example
/// ```gleam
/// pub fn main() {
///   test_util.run_module_tests("response_builder_test")
/// }
/// ```
